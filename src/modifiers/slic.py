...
class SLICModifier(Modifier):
    ...
    def apply(self, image=None, segments=None, parameters=None):
        ...
        return segmentation.slic(image, n_segments=parameters["n_segments"], compactness=parameters["compactness"], mask=segments, channel_axis=None) + parameters["start_label"]